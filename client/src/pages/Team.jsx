    ...
    return (
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                ...
                <button onClick={() => setIsDialogOpen(true)} className="flex items-center px-5 py-2 rounded text-sm bg-linear-to-l from-ziedet-main to-ziedet-button hover:opacity-90 text-white transition" >
            ...
            <div className="flex flex-wrap gap-4">
                ...
                <div className="max-sm:w-full dark:bg-linear-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-gray-300 dark:border-zinc-800 rounded-lg p-6">
                    <div className="flex items-center justify-between gap-8 md:gap-22">
                        ...
                        <div className="p-3 rounded-xl bg-ziedet-white dark:bg-ziedet-main/10">
                            <UsersIcon className="size-4 text-ziedet-main dark:text-ziedet-hover" />
                        </div>
                    </div>
                </div>
