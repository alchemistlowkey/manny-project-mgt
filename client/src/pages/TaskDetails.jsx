        ...
        <div className="p-5 rounded-md  border border-gray-300 dark:border-zinc-800  flex flex-col lg:h-[80vh]">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3">
            <textarea
              ...
              className="w-full dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-md p-2 text-sm text-gray-900 dark:text-zinc-200 resize-none focus:outline-none focus:ring-1 focus:ring-ziedet-main"
              rows={3}
            />
            <button
              onClick={handleAddComment}
              className="bg-linear-to-l from-ziedet-main to-ziedet-button transition-colors text-white text-sm px-5 py-2 rounded "
            >
              Post
            </button>
          </div>
        ...
        <div className="p-5 rounded-md bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 ">
          <div className="mb-3">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              <span className="px-2 py-0.5 rounded bg-ziedet-white dark:bg-ziedet-dull text-ziedet-main dark:text-ziedet-hover text-xs">
                {task.type}
              </span>
