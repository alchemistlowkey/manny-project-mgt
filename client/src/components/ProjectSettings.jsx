...
export default function ProjectSettings({ project }) {
  ...
  const cardClasses =
    "rounded-lg border p-6 not-dark:bg-white dark:bg-linear-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border-zinc-300 dark:border-zinc-800";
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full accent-ziedet-main dark:accent-ziedet-hover"
            />
          </div>
          ...
          <button
            ...
            className="ml-auto flex items-center text-sm justify-center gap-2 bg-linear-to-l from-ziedet-main to-ziedet-button text-white px-4 py-2 rounded"
          >
