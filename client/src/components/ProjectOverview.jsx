...
const ProjectOverview = () => {
    const statusColors = {
        ...
        COMPLETED: "bg-ziedet-white text-ziedet-main dark:bg-ziedet-hover dark:text-ziedet-white",
            ...
            <div className="p-0">
                {projects.length === 0 ? (
                    <div className="p-12 text-center">
                        ...
                        <button onClick={() => setIsDialogOpen(true)} className="mt-4 px-4 py-2 text-sm bg-linear-to-l from-ziedet-main to-ziedet-button text-white dark:text-zinc-200 rounded hover:opacity-90 transition">
                            ...
                            <Link key={project.id} to={`/projectsDetail?id=${project.id}&tab=tasks`} className="block p-6 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="w-full bg-zinc-200 dark:bg-zinc-800 rounded h-1.5">
                                        <div className="h-1.5 bg-ziedet-main rounded" style={{ width: `${project.progress || 0}%` }} />
                                    </div>
                                </div>
                            </Link>
                        ))}
