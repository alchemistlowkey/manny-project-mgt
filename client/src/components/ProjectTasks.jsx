...
const typeIcons = {
  ...
  FEATURE: { icon: Zap, color: "text-ziedet-main dark:text-ziedet-hover" },
...
const priorityTexts = {
  ...
  MEDIUM: {
    background: "bg-ziedet-white dark:bg-ziedet-dull",
    prioritycolor: "text-ziedet-main dark:text-ziedet-hover",
  },
  HIGH: {
      ...
      <div className="flex flex-wrap gap-4 mb-4">
        {["status", "type", "priority", "assignee"].map((name) => {
          ...
          return (
            <select
              ...
              className=" border not-dark:bg-white border-zinc-300 dark:border-zinc-800 outline-none px-3 py-1 rounded text-sm text-zinc-900 dark:text-ziedet-white dark:open:bg-ziedet-dull"
            >
        ...
        {(filters.status ||
          ...
          <button
            ...
            className="px-3 py-1 flex items-center gap-2 rounded bg-linear-to-l from-ziedet-main to-ziedet-button text-zinc-100 dark:text-zinc-200 text-sm transition-colors"
          >
                      ...
                      >
                        ...
                        >
                          <select
                            ...
                            value={task.status}
                            className="group-hover:ring ring-zinc-100 outline-none px-2 pr-4 py-1 rounded text-sm text-zinc-900 dark:text-ziedet-white dark:open:bg-ziedet-dull cursor-pointer"
                          >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        value={task.status}
                        className="w-full mt-1 bg-zinc-100 dark:bg-zinc-800 ring-1 ring-zinc-300 dark:ring-zinc-700 outline-none px-2 py-1 rounded text-sm text-zinc-900 dark:text-ziedet-white dark:open:bg-ziedet-dull"
                      >
                        <option value="TODO">To Do</option>
                        <option value="IN_PROGRESS">In Progress</option>
                        <option value="DONE">Done</option>
