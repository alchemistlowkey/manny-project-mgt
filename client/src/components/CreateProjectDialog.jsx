        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {formData.team_members.length > 0 && (
              <div className="flex flex-wrap gap-2 mt-2">
                {formData.team_members.map((email) => (
                  <div
                    key={email}
                    className="flex items-center gap-1 bg-ziedet-white/50 dark:bg-ziedet-main/20 text-ziedet-main dark:text-ziedet-hover px-2 py-1 rounded-md text-sm"
                  >
                    {email}
                    <button
                      type="button"
                      onClick={() => removeTeamMember(email)}
                      className="ml-1 hover:bg-ziedet-main/30 dark:hover:bg-ziedet-hover/30 rounded"
                    >
          ...
          <div className="flex justify-end gap-3 pt-2 text-sm">
            ...
            <button
              ...
              className="px-4 py-2 rounded bg-linear-to-l from-ziedet-main to-ziedet-button text-white dark:text-zinc-200"
            >
