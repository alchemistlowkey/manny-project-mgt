...
const typeColors = {
    ...
    FEATURE: "bg-ziedet-white text-ziedet-main dark:bg-ziedet-hover dark:text-ziedet-white",
                        ...
                        {daysInMonth.map((day) => {
                            ...
                            return (
                                <button
                                    ...
                                    ${isSelected ? "bg-ziedet-white text-ziedet-main dark:bg-ziedet-hover dark:text-white" : "bg-zinc-50 text-zinc-900 dark:bg-zinc-800/40 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700"}
                                    ${hasOverdue ? "border border-red-300 dark:border-red-500" : ""}`}
                                >
                                    <span>{format(day, "d")}</span>
                                    {dayTasks.length > 0 && (
                                        <span className="text-[10px] text-ziedet-main dark:text-ziedet-white">{dayTasks.length} tasks</span>
                                    )}
                                </button>
                            );
                        })}
