...
const COLORS = ["#0017af", "#10b981", "#f59e0b", "#ef4444", "#8b5cf6"];
const PRIORITY_COLORS = {
    LOW: "text-red-600 bg-red-200 dark:text-red-500 dark:bg-red-600",
    MEDIUM: "text-ziedet-main bg-ziedet-white dark:text-ziedet-hover dark:bg-ziedet-main",
...
const ProjectAnalytics = ({ project, tasks }) => {
    ...
    const metrics = [
        ...
        },
        {
            ...
            color: "text-ziedet-main dark:text-ziedet-hover",
            icon: <Clock className="size-5 text-ziedet-main dark:text-ziedet-hover" />,
            bg: "bg-ziedet-white dark:bg-ziedet-main/10",
        },
        {
            label: "Overdue Tasks",
            value: stats.overdue,
                ...
                <div className="not-dark:bg-white dark:bg-linear-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-300 dark:border-zinc-800 rounded-lg p-6">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={statusData}>
                            ...
                            <Bar dataKey="value" fill="#0017af" radius={[4, 4, 0, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
